...
impl FuncInstance {
  ...
  pub fn call(func_idx: u32, func_instances: &Vec<FuncInstance>, args: Vec<Value>) -> FuncInstance {
  ...
  pub fn call_by_name(name: &str, func_instances: &Vec<FuncInstance>, args: Vec<Value>) -> FuncInstance {
